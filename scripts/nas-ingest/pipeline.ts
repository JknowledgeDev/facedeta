...
/**
 * ชื่อกิจกรรมจาก path สัมพัทธ์ — โฟลเดอร์บน NAS ลึกได้ถึง 9 ชั้น และชื่องานมักอยู่ท้ายๆ
 *   ≤ 4 ชั้น → ต่อทุกชั้น:  พี่เนย/งานในคอม/รวม → "พี่เนย › งานในคอม › รวม"
 *   > 4 ชั้น → เจ้าของ › … › 3 ชั้นสุดท้าย:
 *     พี่เนย/งานในคอม/เนย/2026/…/MED CAMP 2023/เชียงใหม่/Day2+3 → "พี่เนย › … › MED CAMP 2023 › เชียงใหม่ › Day2+3"
 */
